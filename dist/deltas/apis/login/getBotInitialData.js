    ...
    return async (callback) => {
        ...
        api.httpGet(`https://www.facebook.com/profile.php?id=${ctx.userID}`, null, {
            ...
            if (profileMatch && profileMatch[1]) {
                ...
                return callback(null, { error: "Something went wrong. Maybe its possible that it has a limitation due to spam requests. You can try again later." });
        }, true);
        return returnPromise;
    };
}
;
//# sourceMappingURL=getBotInitialData.js.map