...
export function getHeaders(url: string, options?: any, ctx?: any, customHeader?: any): Record<string, string> {
  const {
    userAgent,
    secChUa,
...
export const meta = (prop: string): RegExp => new RegExp(`<meta property="${prop}" content="([^"]*)"`);
